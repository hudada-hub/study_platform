    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex items-start">
        ...
        <div className="ml-3 text-sm">
          <label htmlFor="terms" style={{ color: theme.textColor.primary }}>
            我已查阅并同意
            <Link href="/protocol/1" target="_blank" style={{ color: theme.textColor.primary }} className="mx-1 hover:opacity-80">《用户协议》</Link>
            <Link href="/protocol/2" target="_blank" style={{ color: theme.textColor.primary }} className="mx-1 hover:opacity-80">《版权与免责声明》</Link>
            <Link href="/protocol/3" target="_blank" style={{ color: theme.textColor.primary }} className="mx-1 hover:opacity-80">《用户隐私协议》</Link>
            <Link href="/protocol/4" target="_blank" style={{ color: theme.textColor.primary }} className="mx-1 hover:opacity-80">《用户付费协议》</Link>
          </label>
        </div>
      </div>
