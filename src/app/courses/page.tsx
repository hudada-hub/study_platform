...
const CoursesPage = () => {
  ...
  const priceTypes = [
    { id: 1, name: '免费', value: 'FREE' },
    { id: 2, name: '收费', value: 'PAID' },
  ];
  ...
  useEffect(() => {
    const fetchCourses = async () => {
      ...
      try {
        ...
        if (selectedPrice) params.append('priceType', priceTypes.find(p => p.id === selectedPrice)?.value || '');
    ...
    fetchCourses();
  }, [selectedCategory, selectedDirection, selectedLevel, selectedPrice, activeTab, currentPage, searchKeyword]);
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg p-6 mb-6">
          ...
          <FilterItem
            ...
            onSelect={(id) => handleFilterChange('price', id)}
          />
        </div>
        ...
        <div className="bg-white rounded-lg p-6">
          ...
          {loading ? (
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 mb-8 bg-">
